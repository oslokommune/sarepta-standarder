...
- 06.06.17: v4.1.5 - Adresse i Helsetjenesteenheter: fjernet ledetekst type når adresse mangler.
...
<xsl:stylesheet version="1.0" 
	...
	<xsl:variable name="versjon" select="'henvisning v.uavhengig - v4.1.7 '"/>
				...
				<ul>
					...
					<xsl:if test="//child::*[local-name()='ReasonAsText'][child::*[local-name()='Heading']/@V='ART']">
						<li>
							...
							<a href="#{$temp35}">Andre relaterte tilstander</a>
						</li>
					</xsl:if>
					<xsl:if test="//child::*[local-name()='ReasonAsText'][child::*[local-name()='Heading']/@V='UTRED']">
						<li>
