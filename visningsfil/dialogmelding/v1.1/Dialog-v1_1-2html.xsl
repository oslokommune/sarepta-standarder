...
<xsl:stylesheet version="1.0" 
	...
	<xsl:output method="html" encoding="UTF-8" indent="yes" version="4"
	...
	<xsl:variable name="versjon" select="'dialog1.1 - v3.1.0 '"/>
					...
					<tbody>
						<tr>
							<xsl:for-each select="//mh:Document[position()=1]/mh:ContentDescription">
								<th>Beskrivelsexxxxxxxxxxxxxxxxxxxxxxxxxxx</th>
